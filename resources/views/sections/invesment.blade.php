<section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
                ...
                @if ($investment->type == 'Trading Robots')
                 <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="button-containerI">
                        <a href="{{ route('connexion') }}" class="glow-on-hover"><h4 class="invest-h">INVEST NOW</h4></a>
                    </div>
                    </div>
                  </div>
             @endif
        ...
        <div class="row">
        @foreach ($InvestmentList as $investment)
            @if ($investment->type == 'Crypto currency')
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box iconbox-blue">
                    <div class="icon">
                        <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @if($investment->userlimit == '')
                            <table >
                                ...
                                <tr>
                                    <td>Contact lenght</td>
                                    <td>:</td>
                                    <td>{{ $investment->dureecontrat }} days</td>
                                </tr>
                                <tr>
                                    <td>Daily profit</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>1{{ $investment->profitaccouting }}</td>
                                </tr>
                                <tr>
                                    <td>Principal back</td>
                                    <td>:</td>
                                    <td>{{ $investment->principalback }}</td>
                                </tr>
                            </table>
                        @else
                            <table >
