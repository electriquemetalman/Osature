                                            ...
                                            <div class="widget-content p-0">
                                                <div class="widget-content-wrapper">
                                                    ...
                                                    <div class="widget-content-right mr-2">
                                                        <a href="{{ route('admin_Deconnexion_path') }}" class="btn-pill btn-shadow btn-shine btn btn-focus">Se déconnecter</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="scroll-area-xs" style="height: 150px;">
                                    <div class="scrollbar-container ps">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a href="javascript:void(0);" class="nav-link btn btn-wide">Sécurité</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
