                    ...
                    <div class="input-checkbox">
                        <form  wire:submit.prevent='create'>
                            <div class="">
                              ...
                              <span>Prenom</span>
                                <div class="input-group mb-2 mr-sm-2">
                                  <input class="form-control" type="text" wire:model.lazy="prenom" value="<?php echo e($prenom); ?>" placeholder="" required>
                              </div>

                              <span>Nom d'utilisateur</span>
                                <div class="input-group mb-2 mr-sm-2">
                                  <input class="form-control" type="text" wire:model.lazy="nomuser" value="<?php echo e($nomuser); ?>" placeholder="" required>
                              </div>

                                <span>Email</span>
                                <div class="input-group mb-2 mr-sm-2">
                                  <input class="form-control" type="email" wire:model.lazy="email" value="<?php echo e($email); ?>" placeholder="" required>
                                </div>
                              ...
                              <span>Pays</span>
                                <div class="input-group mb-2 mr-sm-2">
                                  <input class="form-control" type="text" wire:model.lazy="pays" value="<?php echo e($pays); ?>" placeholder="" required>
                                </div>
